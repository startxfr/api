...
function getStaticUrl($type) {
    switch ($type) {
	case 'img': return $GLOBALS['StaticContent']['UrlImg'];
	    break;
	case 'Jss': return $GLOBALS['StaticContent']['urlJss'];
	    break;
	case 'imgPhone': return $GLOBALS['StaticContent']['UrlImgPhone'];
	    break;
	case 'Webapp': return $GLOBALS['StaticContent']['urlWebapp'];
	    break;
	case 'group': return $GLOBALS['StaticContent']['urlGroup'];
	    break;
	default:
	    return '';
	    break;
