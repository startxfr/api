...
) ENGINE=InnoDB AUTO_INCREMENT=25164 DEFAULT CHARSET=utf8;
...
CREATE TABLE `commande` (
  ...
  `paysdelivery_cmd` smallint(3) NOT NULL DEFAULT '1',
  ...
  KEY `villedelivery_cmd` (`villedelivery_cmd`),
  KEY `cpdelivery_cmd` (`cpdelivery_cmd`),
  KEY `tva_cmd` (`tva_cmd`),
  KEY `ren_cmd` (`ren_cmd`)
...
) ENGINE=InnoDB AUTO_INCREMENT=1235 DEFAULT CHARSET=utf8 COMMENT='Detail des produits d''un bon de commande ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contact` (
  ...
  `civ_cont` varchar(5) NOT NULL DEFAULT 'M.',
  ...
  KEY `mob_cont` (`mob_cont`),
  KEY `tel_cont` (`tel_cont`)
) ENGINE=InnoDB AUTO_INCREMENT=135454 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `devis` (
  ...
  `paysdelivery_dev` smallint(3) NOT NULL DEFAULT '1',
  ...
  KEY `BDCclient_dev` (`BDCclient_dev`),
  KEY `nomdelivery_dev` (`nomdelivery_dev`),
  KEY `tva_dev` (`tva_dev`)
...
CREATE TABLE `devis_produit` (
  ...
  KEY `id_produit` (`id_produit`)
) ENGINE=InnoDB AUTO_INCREMENT=5097 DEFAULT CHARSET=utf8 COMMENT='Detail des produits devisés ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `facture` (
  ...
  `pays_fact` smallint(3) unsigned NOT NULL DEFAULT '1',
  ...
  KEY `tauxTVA_fact` (`tauxTVA_fact`),
  KEY `BDCclient_fact` (`BDCclient_fact`),
  KEY `numeroTVA_fact` (`numeroTVA_fact`),
  KEY `datereglement_fact` (`datereglement_fact`),
  KEY `dateenvoi_fact` (`dateenvoi_fact`),
  KEY `daterecord_fact` (`daterecord_fact`),
  KEY `datemodif_fact` (`datemodif_fact`),
  KEY `maildelivery_fact` (`maildelivery_fact`),
  KEY `type_fact` (`type_fact`),
  KEY `file_fact` (`file_fact`),
  KEY `ren_fact` (`ren_fact`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2376 DEFAULT CHARSET=utf8 COMMENT='Detail des produits d''une facture ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fournisseur` (
  ...
  KEY `entreprise_fourn` (`entreprise_fourn`),
  KEY `contactComm_fourn` (`contactComm_fourn`),
  KEY `ContactADV_fourn` (`ContactADV_fourn`),
  KEY `contactFact_fourn` (`contactFact_fourn`),
  KEY `BDCCannevas_fourn` (`BDCCannevas_fourn`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `journal_banque` (
  ...
  PRIMARY KEY (`id_jb`)
) ENGINE=InnoDB AUTO_INCREMENT=685 DEFAULT CHARSET=utf8 COMMENT='table de journal de banque pour les mouvements de compte';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log` (
  ...
  `trace_log` text,
  PRIMARY KEY (`id_log`)
) ENGINE=InnoDB AUTO_INCREMENT=2842580 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produit` (
  ...
  KEY `refExterne` (`refExterne`),
  KEY `prix_prod` (`prix_prod`),
  KEY `stock_prod` (`stock_prod`),
  KEY `bestsell_prod` (`bestsell_prod`),
  KEY `stillAvailable_prod` (`stillAvailable_prod`),
  KEY `archi_prod` (`archi_prod`),
  KEY `contrat_prod` (`contrat_prod`),
  KEY `familleredhat_prod` (`familleredhat_prod`),
  KEY `prodredhat_prod` (`prodredhat_prod`)
...
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='Type de produit';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-08-18 23:21:36
