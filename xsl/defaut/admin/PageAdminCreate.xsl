...
<xsl:template match="page" mode="contentFile">
	...
	<br class="clear"/>
	<div class="footer">
		<a href="javascript:document.pageModifFile.reset()"><img align="middle" title="../img/prospec/cancel.png" alt="../img/prospec/cancel.png" name="img" src="../img/prospec/cancel.png"/> Annuler</a>
		<a href="javascript:document.pageModifFile.submit()"><img align="middle" title="../img/prospec/record.png" alt="../img/prospec/record.png" name="img" src="../img/prospec/record.png"/> Ajouter ce document</a>
	</div>
</xsl:template>
