...
<head>
  ...
  <title>Welcome to Zend Server on OpenShift</title>
  <style> 
  ...
  .zend-logo {
    ...
    width: 49px;
    margin: 0;
    background-image: url(data:image/png;base64,);
  }
  *, *:before, *:after {
  ...
  .col-sm-6, .col-md-6, .col-xs-12,.col-md-12 {
    position: relative;
    min-height: 1px;
    padding-left: 15px;
    padding-right: 15px;
...
<section class='container'>
    ...
    <div class="row">
      <section class="col-md-12">
        <figure class="zend-logo left">
          <a href="http://www.zend.com/en/products/server/"></a>
        </figure>

        <div class="right">
          <p>Zend Server is a professional-grade PHP runtime
        environment ideal for building and running high-quality PHP apps.
        With Zend Server on OpenShift, you'll get a tested and certified
        version of the open source PHP engine you already know, plus
        application deployment and rollback, application monitoring and root
        cause analysis, advanced debugging, and caching tools. All these
        tools are web-service enabled and can be fully automated,
        facilitating easy integration into your continuous delivery cycle. <a href="http://www.zend.com/en/products/server/">Learn more about Zend Server</a>
          </p>
          <a href="/ZendServer">Access the Zend Server user interface</a>
        </div>
      </section>
    </div>
        <div class="row">
...
$ git push</pre>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h2>Zend Server Resources</h2>
                <ul>
                  <li><a href="http://files.zend.com/help/Zend-Server/zend-server.htm">Zend Server User Guide</a></li>
                  <li><a href="http://files.zend.com/help/Zend-Server/zend-server.htm#videos.htm">Zend Server Videos</a></li>
                  <li><a href="http://forums.zend.com/">Zend Server Forums</a></li>
                  <li><a href="http://devzone.zend.com/">Zend Developer Zone</a></li>
                </ul>
