...
?>
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
        ...
        <body>
    	<div class="opensrc"><img src="http://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Opensource.svg/288px-Opensource.svg.png" alt="home" /></div>
    	<div style="float:right">
    	    <a href="#" onclick="display_('touch');"><img title="Cree un fichier"  alt="" src="<?php echo $IMGCREATEFILE; ?>" /></a><br />
    	    <a href="#" onclick="display_('upload');"><img title="Telecharger un fichier"  alt="" src="<?php echo $IMGUPLOAD; ?>" /></a><br />
    	    <a href="#" onclick="display_('mkdir');"><img title="Cree un dossier"  alt="" src="<?php echo $IMGCREATEFOLDER; ?>" /></a><br />
    	    <a href="#" onclick="display_('search');"><img title="Chercher"  alt="" src="<?php echo $IMGSEARCH; ?>" /></a><br />
    	    <a href="#" onclick="display_('rename');"><img title="Renommer"  alt="" src="<?php echo $IMGRENAME; ?>" /></a><br />
    	</div>
<?php
