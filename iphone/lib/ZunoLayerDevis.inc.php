 ...
 class ZunoLayerDevis
 {
 	static function loadDefaultLayer()
 	{
 		...
 		return '<!------------------------------------ -->
				...
				<a href="Devis.php?action=addDevis" rev="async" rel="action" class="iButton iBClassic"><img src="'.getStaticUrl('imgPhone').'add.png" alt="Créer un devis" /></a>
				...
				<a href="#"  onclick="return WA.Submit(\'formSearchDevis\',null,event)" rel="action" class="iButton iBAction"><img src="'.getStaticUrl('imgPhone').'search.png" alt="recherche" /></a>
				...
				<a href="#"  onclick="return WA.Submit(\'formStatsDevis\',null,event)" rel="action" class="iButton iBAction"><img src="'.getStaticUrl('imgPhone').'stats.png" alt="Statistiques" /></a>
				'.$footer.'
				</div>
		';
 	}
 	...
 	static function iMenuGeneral()
 	{
 		return '<div class="iMenu">
				<ul class="iArrow">
 					<li><a href="#_SearchDevis" class="Devis"><img src="'.getStaticUrl('imgPhone').'iconMenu/devis.search.png" alt="Recherche" /> Rechercher</a></li>
 					<li><a href="Devis.php?action=addDevis" rev="async" rel="action" class="Devis"><img src="'.getStaticUrl('imgPhone').'iconMenu/devis.add.png" alt="Ajouter" /> Créer</a></li>
 					<li><a href="Devis.php?action=voirStats" rev="async" class="Devis"><img src="'.getStaticUrl('imgPhone').'iconMenu/devis.stat.png" alt="Statistiques" />Statistiques</a></li>
 				</ul>
 				<ul class="iArrow">
 					<li><a href="Devis.php?action=addDevisExpress" rev="async" rel="action" class="Devis"><img src="'.getStaticUrl('imgPhone').'iconMenu/devis.addExp.png" alt="Ajouter Express" /> Devis Express</a></li>
	...
	'<form id="formAutoChargeDevisTri" action="Devis.php?action=tri_'.$tri.'" onsubmit="return WA.Submit(this,null,event)"><a id="lienAutoChargeDevisTri" onclick="return WA.Submit(\'formAutoChargeDevisTri\',null,event)"></a></form>';
 	...
 	static function iMenuNew()
 	{
 		return '<div class="iMenu">
		<ul class="iArrow">
			<li><a href="Devis.php?action=addDevis" rev="async" rel="action"><img src="'.getStaticUrl('imgPhone').'iconMenu/devis.add.png" alt="Ajouter" />Ajouter un nouveau devis</a></li>
		</ul>
		</div>';
 	}
					...
					<div class="iPanel">
						<div id="form-searchDevis"></div>
							<fieldset>
								...
								<br/>
								<a href="#" onclick="return WA.Submit(\'formSearchDevis\',null,event)" class="whiteButton"><img src="'.getStaticUrl('imgPhone').'search.png" style="float: left"/><span>Lancer la recherche</span></a>
							</fieldset>
						</div>
				</form>';
 	}
...
static function headerFormSearchDev()
	...
	return '<form action="Devis.php?action=inputDevisResult" id="formSearchDevisajax" onsubmit="return WA.Submit(this,null,event)"><div  class="iFormI">
			<a href="#_SearchDevisResult" rel="action" onclick="return WA.Submit(\'formSearchDevisajax\',null,event)" class="iButton iBAction"><img src="'.getStaticUrl('imgPhone').'search.png" alt="Recherche" /></a>
