...
function ZunoErrorHandlerIPhone($errno, $errstr, $errfile, $errline) {

    $o = $t = '';
    switch ($errno) {
	case E_ERROR:		$t = 'Error';
	    break;
	case E_CORE_ERROR:	$t = 'Core Error';
	    break;
	case E_USER_ERROR:	$t = 'User Error';
	    break;
	case E_WARNING:		$t = 'Alert';
	    break;
	case E_CORE_WARNING:	$t = 'Core Alert';
	    break;
	case E_USER_WARNING:	$t = 'User Alert';
	    break;
	case E_NOTICE:		$t = '';
	    break;
	case E_USER_NOTICE:	$t = '';
	    break;
	case E_STRICT:		$t = '';
	    break;
	default:			$t = 'Autre';
...
set_error_handler("ZunoErrorHandlerIPhone");
