##applicationSessionsResource

access to session application

|name|type|mandatory|desc|
|----|----|----|----|
|exclude_data|array|false|data not to return|
...
* [defaultResource](Resources_defaultResource)
  * [defaultSessionResource](Resources_defaultSessionResource)
    * applicationSessionsResource
